...
- `OWNER_ADDRESSES` — array of exact-match owner address strings with owner-level permissions; entries may be hexadecimal wallet addresses or ENS names. It currently contains one entry: `Yaketh.eth`.
