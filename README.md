...
- `PHONE_NUMBER` — phone number snapshot resolved at process startup from the `PHONE_NUMBER` environment variable, or fallback placeholder `YOUR_PHONE_NUMBER` when unset.
